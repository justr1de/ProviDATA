...
export function ThemeToggle() {
  ...
  const getTooltipText = () => {
    if (theme === 'system') return 'Tema: Sistema (clique para alternar)';
    if (theme === 'dark') return 'Tema: Escuro (clique para alternar)';
...
export function ThemeSelector() {
  ...
  return (
    <div className="flex items-center gap-1 rounded-lg border border-gray-200 bg-gray-100 p-1 dark:border-gray-700 dark:bg-gray-800">
      <Tooltip content="Tema claro" position="top">
        <button
      ...
      <Tooltip content="Tema escuro" position="top">
        <button
      ...
      <Tooltip content="Usar tema do sistema" position="top">
        <button
