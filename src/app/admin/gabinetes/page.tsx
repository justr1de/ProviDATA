        ...
        <>
          ...
          >
            <div className="sticky top-0 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-6 py-5 flex items-center justify-between z-10">
              <h3 id="modal-title" className="text-xl font-bold text-gray-900 dark:text-white">Novo Gabinete</h3>
              <button 
                onClick={handleCloseModal} 
            ...
            <form onSubmit={handleSubmit} className="p-6 sm:p-8 space-y-6">
              ...
              <div className="flex gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
                ...
                <button 
                  type="submit" 
                  disabled={submitting} 
                  className="flex-1 px-5 py-3 text-sm font-semibold rounded-lg bg-blue-600 hover:bg-blue-700 text-white transition-colors disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
