...
CREATE OR REPLACE FUNCTION "public"."accept_invite"("invite_token" "text", "user_id" "uuid") RETURNS "jsonb"
...
ALTER FUNCTION "public"."accept_invite"("invite_token" "text", "user_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."aceitar_convite"("convite_token" "text", "user_id" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
...
BEGIN
    ...
    -- Valida se o email bate
    IF NOT EXISTS (SELECT 1 FROM auth.users WHERE id = user_id AND email = convite_record.email) THEN
        RETURN jsonb_build_object('success', false, 'error', 'Email não corresponde');
    END IF;
    ...
    SET
        ...
        gabinete_id = convite_record.gabinete_id, -- Usa nome correto da coluna
        updated_at = NOW()
    WHERE id = user_id;
...
ALTER FUNCTION "public"."aceitar_convite"("convite_token" "text", "user_id" "uuid") OWNER TO "postgres";


COMMENT ON FUNCTION "public"."aceitar_convite"("convite_token" "text", "user_id" "uuid") IS 'Aceita um convite válido e associa o usuário ao gabinete';



CREATE OR REPLACE FUNCTION "public"."check_prazo_providencias"() RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
  prov RECORD;
BEGIN
  FOR prov IN
    ...
    WHERE p.prazo_estimado IS NOT NULL
    AND p.status NOT IN ('concluido', 'arquivado')
    AND p.prazo_estimado <= CURRENT_DATE + INTERVAL '3 days'
    AND NOT EXISTS (
      SELECT 1 FROM notificacoes n
      WHERE n.providencia_id = p.id
      AND n.tipo = 'prazo_proximo'
      AND n.created_at > NOW() - INTERVAL '1 day'
    )
  LOOP
    INSERT INTO notificacoes (tenant_id, usuario_id, providencia_id, tipo, titulo, mensagem)
    VALUES (
      prov.tenant_id,
      prov.user_id,
      prov.id,
      'prazo_proximo',
      'Prazo próximo: ' || prov.titulo,
      'A providência ' || prov.numero_protocolo || ' tem prazo para ' || TO_CHAR(prov.prazo_estimado, 'DD/MM/YYYY')
    );
  END LOOP;
END;
$$;
...
ALTER FUNCTION "public"."check_prazo_providencias"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."create_providencia_history"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  IF TG_OP = 'INSERT' THEN
    INSERT INTO historico (providencia_id, usuario_id, tipo, descricao, dados_novos)
    VALUES (NEW.id, NEW.usuario_responsavel_id, 'criacao', 'Providência criada', row_to_json(NEW));
  ELSIF TG_OP = 'UPDATE' THEN
    IF OLD.status != NEW.status THEN
      INSERT INTO historico (providencia_id, usuario_id, tipo, descricao, dados_anteriores, dados_novos)
      VALUES (
        NEW.id,
...
ALTER FUNCTION "public"."create_providencia_history"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."create_super_admin"("admin_email" "text", "admin_password" "text", "admin_name" "text" DEFAULT 'Administrador Geral'::"text") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    new_user_id UUID;
...
ALTER FUNCTION "public"."create_super_admin"("admin_email" "text", "admin_password" "text", "admin_name" "text") OWNER TO "postgres";


COMMENT ON FUNCTION "public"."create_super_admin"("admin_email" "text", "admin_password" "text", "admin_name" "text") IS 'Cria ou atualiza usuário como super admin';



CREATE OR REPLACE FUNCTION "public"."expirar_convites_antigos"() RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
    UPDATE public.convites
...
ALTER FUNCTION "public"."expirar_convites_antigos"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."generate_protocolo"("tenant_uuid" "uuid") RETURNS character varying
    LANGUAGE "plpgsql"
    AS $$
DECLARE
  ano VARCHAR(4);
...
BEGIN
  ...
  SELECT COALESCE(MAX(
    CAST(SPLIT_PART(numero_protocolo, '-', 2) AS INT)
  ), 0) + 1
  INTO sequencia
  FROM providencias
  WHERE tenant_id = tenant_uuid
  AND numero_protocolo LIKE ano || '-%';
...
ALTER FUNCTION "public"."generate_protocolo"("tenant_uuid" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."obter_estatisticas_gabinete"("gabinete_uuid" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    stats JSONB;
...
ALTER FUNCTION "public"."obter_estatisticas_gabinete"("gabinete_uuid" "uuid") OWNER TO "postgres";


COMMENT ON FUNCTION "public"."obter_estatisticas_gabinete"("gabinete_uuid" "uuid") IS 'Retorna estatísticas de usuários e convites do gabinete';



CREATE OR REPLACE FUNCTION "public"."planet_osm_line_osm2pgsql_valid"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
CREATE OR REPLACE FUNCTION "public"."planet_osm_point_osm2pgsql_valid"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  IF ST_IsValid(NEW.way) THEN 
...
CREATE OR REPLACE FUNCTION "public"."planet_osm_polygon_osm2pgsql_valid"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  IF ST_IsValid(NEW.way) THEN 
...
CREATE OR REPLACE FUNCTION "public"."planet_osm_roads_osm2pgsql_valid"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  IF ST_IsValid(NEW.way) THEN 
...
CREATE OR REPLACE FUNCTION "public"."revogar_convite"("convite_id" "uuid", "user_id" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    gabinete_alvo UUID;
BEGIN
    -- Pega o ID do gabinete desse convite
    SELECT gabinete_id INTO gabinete_alvo FROM public.convites WHERE id = convite_id;

    -- Verifica se quem está pedindo é admin DESSE gabinete
    IF NOT EXISTS (
        SELECT 1 FROM public.profiles
        WHERE id = user_id 
        AND gabinete_id = gabinete_alvo
        AND role IN ('admin', 'super_admin', 'gestor')
    ) THEN
        RETURN jsonb_build_object('success', false, 'error', 'Sem permissão');
    END IF;

    UPDATE public.convites SET status = 'revogado', updated_at = NOW() WHERE id = convite_id;
    RETURN jsonb_build_object('success', true);
END;
$$;


ALTER FUNCTION "public"."revogar_convite"("convite_id" "uuid", "user_id" "uuid") OWNER TO "postgres";


COMMENT ON FUNCTION "public"."revogar_convite"("convite_id" "uuid", "user_id" "uuid") IS 'Revoga um convite (apenas admins/gestores do gabinete)';



CREATE OR REPLACE FUNCTION "public"."setup_super_admin_profile"("user_id" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    org_id UUID := '00000000-0000-0000-0000-000000000001';
...
ALTER FUNCTION "public"."setup_super_admin_profile"("user_id" "uuid") OWNER TO "postgres";


COMMENT ON FUNCTION "public"."setup_super_admin_profile"("user_id" "uuid") IS 'Configura perfil de super admin para usuário existente';



CREATE OR REPLACE FUNCTION "public"."update_dashboard_stats"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
  v_tenant_id UUID;
BEGIN
  ...
  SELECT
    ...
    COUNT(*) FILTER (WHERE status = 'encaminhado'),
    COUNT(*) FILTER (WHERE status = 'em_andamento'),
    COUNT(*) FILTER (WHERE status = 'concluido'),
    COUNT(*) FILTER (WHERE status = 'arquivado'),
    COUNT(*) FILTER (WHERE prioridade = 'urgente' AND status NOT IN ('concluido', 'arquivado')),
    COUNT(*) FILTER (WHERE prazo_estimado < CURRENT_DATE AND status NOT IN ('concluido', 'arquivado')),
    COUNT(*) FILTER (WHERE DATE_TRUNC('month', created_at) = DATE_TRUNC('month', CURRENT_DATE))
  FROM providencias
  WHERE tenant_id = v_tenant_id
  ON CONFLICT (tenant_id) DO UPDATE SET
    total_providencias = EXCLUDED.total_providencias,
    pendentes = EXCLUDED.pendentes,
    em_analise = EXCLUDED.em_analise,
    encaminhadas = EXCLUDED.encaminhadas,
    em_andamento = EXCLUDED.em_andamento,
    concluidas = EXCLUDED.concluidas,
    arquivadas = EXCLUDED.arquivadas,
    urgentes = EXCLUDED.urgentes,
    atrasadas = EXCLUDED.atrasadas,
    este_mes = EXCLUDED.este_mes,
    updated_at = NOW();
...
-- ⚠️ FOREIGN DATA WRAPPER REMOVIDO POR SEGURANÇA
-- Credenciais não devem estar em migrations versionadas
-- Consulte: docs/FDW_SETUP.md para configurar em cada ambiente
...
CREATE TABLE IF NOT EXISTS "public"."providencias" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
    "gabinete_id" "uuid",
    "numero_protocolo" character varying(50) NOT NULL,
    "cidadao_id" "uuid",
    "categoria_id" "uuid",
    "orgao_destino_id" "uuid",
    "usuario_responsavel_id" "uuid",
    "titulo" character varying(255) NOT NULL,
    "descricao" "text" NOT NULL,
    "localizacao_tipo" character varying(50),
    ...
    "prazo_estimado" "date",
    "data_encaminhamento" timestamp with time zone,
...
ALTER TABLE "public"."providencias" OWNER TO "postgres";


CREATE OR REPLACE VIEW "public"."dashboard_stats" AS
 SELECT "gabinete_id",
    "count"(*) AS "total_providencias",
    "count"(*) FILTER (WHERE (("status")::"text" = 'pendente'::"text")) AS "pendentes",
    "count"(*) FILTER (WHERE (("status")::"text" = 'em_analise'::"text")) AS "em_analise",
    "count"(*) FILTER (WHERE (("status")::"text" = 'encaminhado'::"text")) AS "encaminhadas",
    "count"(*) FILTER (WHERE (("status")::"text" = 'em_andamento'::"text")) AS "em_andamento",
    "count"(*) FILTER (WHERE (("status")::"text" = 'concluido'::"text")) AS "concluidas",
    "count"(*) FILTER (WHERE (("status")::"text" = 'arquivado'::"text")) AS "arquivadas",
    "count"(*) FILTER (WHERE (("prioridade")::"text" = 'urgente'::"text")) AS "urgentes",
    "count"(*) FILTER (WHERE (("prazo_estimado" < CURRENT_DATE) AND (("status")::"text" <> ALL (ARRAY[('concluido'::character varying)::"text", ('arquivado'::character varying)::"text"])))) AS "atrasadas",
    "count"(*) FILTER (WHERE ("created_at" >= "date_trunc"('month'::"text", (CURRENT_DATE)::timestamp with time zone))) AS "este_mes"
...
CREATE TABLE IF NOT EXISTS "public"."documentos" (
    ...
    "arquivo_tipo" character varying(100),
...
CREATE TABLE IF NOT EXISTS "public"."gabinetes" (
    ...
    CONSTRAINT "gabinetes_parlamentar_cargo_check" CHECK (("parlamentar_cargo" = ANY (ARRAY['vereador'::"text", 'prefeito'::"text", 'deputado_estadual'::"text", 'deputado_federal'::"text", 'senador'::"text", 'governador'::"text"]))),
    CONSTRAINT "gabinetes_uf_check" CHECK (("length"("uf") = 2))
);


ALTER TABLE "public"."gabinetes" OWNER TO "postgres";
...
COMMENT ON COLUMN "public"."gabinetes"."chefe_de_gabinete" IS 'Nome do primeiro assessor (opcional)';
...
CREATE TABLE IF NOT EXISTS "public"."historico_providencias" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
...
ALTER TABLE "public"."historico_providencias" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."planet_osm_nodes" (
    "id" bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS "public"."planet_osm_rels" (
    "id" bigint NOT NULL,
    "way_off" smallint,
    "rel_off" smallint,
    "parts" bigint[],
...
CREATE TABLE IF NOT EXISTS "public"."planet_osm_ways" (
    "id" bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS "public"."profiles" (
    ...
    "gabinete_id" "uuid",
    "cargo" "text" DEFAULT 'assessor'::"text"
);
...
CREATE TABLE IF NOT EXISTS "public"."users" (
    ...
    "role" character varying(50) DEFAULT 'colaborador'::character varying,
    "avatar_url" "text",
    "ativo" boolean DEFAULT true,
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"()
...
ALTER TABLE ONLY "public"."gabinetes"
    ADD CONSTRAINT "gabinetes_nome_municipio_uf_unique" UNIQUE ("nome", "municipio", "uf");



ALTER TABLE ONLY "public"."gabinetes"
    ADD CONSTRAINT "gabinetes_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."gabinetes"
    ADD CONSTRAINT "gabinetes_slug_key" UNIQUE ("slug");
...
ALTER TABLE ONLY "public"."historico_providencias"
    ADD CONSTRAINT "historico_providencias_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."providencias"
    ADD CONSTRAINT "providencias_numero_protocolo_key" UNIQUE ("numero_protocolo");



ALTER TABLE ONLY "public"."providencias"
    ADD CONSTRAINT "providencias_pkey" PRIMARY KEY ("id");
...
CREATE INDEX "categorias_gabinete_id_idx" ON "public"."categorias" USING "btree" ("gabinete_id");



CREATE INDEX "cidadaos_gabinete_id_idx" ON "public"."cidadaos" USING "btree" ("gabinete_id");



CREATE INDEX "documentos_gabinete_id_idx" ON "public"."documentos" USING "btree" ("gabinete_id");



CREATE INDEX "idx_anexos_providencia" ON "public"."anexos" USING "btree" ("providencia_id");



CREATE INDEX "idx_categorias_tenant" ON "public"."categorias" USING "btree" ("gabinete_id");



CREATE INDEX "idx_categorias_tenant_created_at" ON "public"."categorias" USING "btree" ("gabinete_id", "created_at" DESC);



CREATE INDEX "idx_categorias_tenant_id" ON "public"."categorias" USING "btree" ("gabinete_id");



CREATE INDEX "idx_cidadaos_cpf" ON "public"."cidadaos" USING "btree" ("cpf");



CREATE INDEX "idx_cidadaos_tenant" ON "public"."cidadaos" USING "btree" ("gabinete_id");



CREATE INDEX "idx_cidadaos_tenant_created_at" ON "public"."cidadaos" USING "btree" ("gabinete_id", "created_at" DESC);



CREATE INDEX "idx_cidadaos_tenant_id" ON "public"."cidadaos" USING "btree" ("gabinete_id");



CREATE INDEX "idx_documentos_categoria" ON "public"."documentos" USING "btree" ("categoria");



CREATE INDEX "idx_documentos_tenant" ON "public"."documentos" USING "btree" ("gabinete_id");



CREATE INDEX "idx_documentos_tenant_created_at" ON "public"."documentos" USING "btree" ("gabinete_id", "created_at" DESC);



CREATE INDEX "idx_documentos_tenant_id" ON "public"."documentos" USING "btree" ("gabinete_id");



CREATE INDEX "idx_gabinetes_ativo" ON "public"."gabinetes" USING "btree" ("ativo");



CREATE INDEX "idx_gabinetes_created_at" ON "public"."gabinetes" USING "btree" ("created_at");



CREATE INDEX "idx_gabinetes_municipio" ON "public"."gabinetes" USING "btree" ("municipio");



CREATE INDEX "idx_gabinetes_uf" ON "public"."gabinetes" USING "btree" ("uf");



CREATE INDEX "idx_historico_providencia" ON "public"."historico" USING "btree" ("providencia_id");
...
CREATE INDEX "idx_notificacoes_tenant_created_at" ON "public"."notificacoes" USING "btree" ("gabinete_id", "created_at" DESC);



CREATE INDEX "idx_notificacoes_tenant_id" ON "public"."notificacoes" USING "btree" ("gabinete_id");
...
CREATE INDEX "idx_orgaos_tenant" ON "public"."orgaos" USING "btree" ("gabinete_id");



CREATE INDEX "idx_orgaos_tenant_created_at" ON "public"."orgaos" USING "btree" ("gabinete_id", "created_at" DESC);



CREATE INDEX "idx_orgaos_tenant_id" ON "public"."orgaos" USING "btree" ("gabinete_id");
...
CREATE INDEX "idx_profiles_gabinete" ON "public"."profiles" USING "btree" ("gabinete_id");



CREATE INDEX "idx_profiles_gabinete_id" ON "public"."profiles" USING "btree" ("gabinete_id");



CREATE INDEX "idx_profiles_gabinete_role" ON "public"."profiles" USING "btree" ("gabinete_id", "role");
...
CREATE INDEX "idx_providencias_cidadao" ON "public"."providencias" USING "btree" ("cidadao_id");



CREATE INDEX "idx_providencias_protocolo" ON "public"."providencias" USING "btree" ("numero_protocolo");



CREATE INDEX "idx_providencias_status" ON "public"."providencias" USING "btree" ("status");



CREATE INDEX "idx_providencias_tenant" ON "public"."providencias" USING "btree" ("gabinete_id");



CREATE INDEX "idx_providencias_tenant_created_at" ON "public"."providencias" USING "btree" ("gabinete_id", "created_at" DESC);



CREATE INDEX "idx_providencias_tenant_id" ON "public"."providencias" USING "btree" ("gabinete_id");



CREATE INDEX "idx_users_tenant" ON "public"."users" USING "btree" ("gabinete_id");



CREATE INDEX "idx_users_tenant_id" ON "public"."users" USING "btree" ("gabinete_id");



CREATE INDEX "notificacoes_gabinete_id_idx" ON "public"."notificacoes" USING "btree" ("gabinete_id");



CREATE INDEX "orgaos_gabinete_id_idx" ON "public"."orgaos" USING "btree" ("gabinete_id");
...
CREATE INDEX "profiles_gabinete_id_idx" ON "public"."profiles" USING "btree" ("gabinete_id");



CREATE INDEX "providencias_gabinete_id_idx" ON "public"."providencias" USING "btree" ("gabinete_id");



CREATE INDEX "users_gabinete_id_idx" ON "public"."users" USING "btree" ("gabinete_id");



CREATE OR REPLACE TRIGGER "planet_osm_line_osm2pgsql_valid" BEFORE INSERT OR UPDATE ON "public"."planet_osm_line" FOR EACH ROW EXECUTE FUNCTION "public"."planet_osm_line_osm2pgsql_valid"();



CREATE OR REPLACE TRIGGER "planet_osm_point_osm2pgsql_valid" BEFORE INSERT OR UPDATE ON "public"."planet_osm_point" FOR EACH ROW EXECUTE FUNCTION "public"."planet_osm_point_osm2pgsql_valid"();



CREATE OR REPLACE TRIGGER "planet_osm_polygon_osm2pgsql_valid" BEFORE INSERT OR UPDATE ON "public"."planet_osm_polygon" FOR EACH ROW EXECUTE FUNCTION "public"."planet_osm_polygon_osm2pgsql_valid"();



CREATE OR REPLACE TRIGGER "planet_osm_roads_osm2pgsql_valid" BEFORE INSERT OR UPDATE ON "public"."planet_osm_roads" FOR EACH ROW EXECUTE FUNCTION "public"."planet_osm_roads_osm2pgsql_valid"();



CREATE OR REPLACE TRIGGER "providencia_history_trigger" AFTER INSERT OR UPDATE ON "public"."providencias" FOR EACH ROW EXECUTE FUNCTION "public"."create_providencia_history"();



CREATE OR REPLACE TRIGGER "update_cidadaos_updated_at" BEFORE UPDATE ON "public"."cidadaos" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at"();



CREATE OR REPLACE TRIGGER "update_gabinetes_updated_at" BEFORE UPDATE ON "public"."gabinetes" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();



CREATE OR REPLACE TRIGGER "update_orgaos_updated_at" BEFORE UPDATE ON "public"."orgaos" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at"();
...
CREATE OR REPLACE TRIGGER "update_providencias_updated_at" BEFORE UPDATE ON "public"."providencias" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at"();
...
ALTER TABLE ONLY "public"."anexos"
    ADD CONSTRAINT "anexos_providencia_id_fkey" FOREIGN KEY ("providencia_id") REFERENCES "public"."providencias"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."categorias"
    ADD CONSTRAINT "categorias_gabinete_id_fkey" FOREIGN KEY ("gabinete_id") REFERENCES "public"."gabinetes"("id");



ALTER TABLE ONLY "public"."cidadaos"
    ADD CONSTRAINT "cidadaos_gabinete_id_fkey" FOREIGN KEY ("gabinete_id") REFERENCES "public"."gabinetes"("id");



ALTER TABLE ONLY "public"."documentos"
    ADD CONSTRAINT "documentos_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id");



ALTER TABLE ONLY "public"."documentos"
    ADD CONSTRAINT "documentos_gabinete_id_fkey" FOREIGN KEY ("gabinete_id") REFERENCES "public"."gabinetes"("id");



ALTER TABLE ONLY "public"."historico"
    ADD CONSTRAINT "historico_providencia_id_fkey" FOREIGN KEY ("providencia_id") REFERENCES "public"."providencias"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."historico_providencias"
    ADD CONSTRAINT "historico_providencias_providencia_id_fkey" FOREIGN KEY ("providencia_id") REFERENCES "public"."providencias"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."historico_providencias"
    ADD CONSTRAINT "historico_providencias_usuario_id_fkey" FOREIGN KEY ("usuario_id") REFERENCES "public"."users"("id");



ALTER TABLE ONLY "public"."historico"
    ADD CONSTRAINT "historico_usuario_id_fkey" FOREIGN KEY ("usuario_id") REFERENCES "public"."users"("id");



ALTER TABLE ONLY "public"."notificacoes"
    ADD CONSTRAINT "notificacoes_gabinete_id_fkey" FOREIGN KEY ("gabinete_id") REFERENCES "public"."gabinetes"("id");



ALTER TABLE ONLY "public"."notificacoes"
    ADD CONSTRAINT "notificacoes_providencia_id_fkey" FOREIGN KEY ("providencia_id") REFERENCES "public"."providencias"("id");



ALTER TABLE ONLY "public"."notificacoes"
    ADD CONSTRAINT "notificacoes_usuario_id_fkey" FOREIGN KEY ("usuario_id") REFERENCES "public"."users"("id");



ALTER TABLE ONLY "public"."orgaos"
    ADD CONSTRAINT "orgaos_gabinete_id_fkey" FOREIGN KEY ("gabinete_id") REFERENCES "public"."gabinetes"("id");



ALTER TABLE ONLY "public"."profiles"
    ADD CONSTRAINT "profiles_gabinete_id_fkey" FOREIGN KEY ("gabinete_id") REFERENCES "public"."gabinetes"("id");



ALTER TABLE ONLY "public"."providencias"
    ADD CONSTRAINT "providencias_categoria_id_fkey" FOREIGN KEY ("categoria_id") REFERENCES "public"."categorias"("id");



ALTER TABLE ONLY "public"."providencias"
    ADD CONSTRAINT "providencias_cidadao_id_fkey" FOREIGN KEY ("cidadao_id") REFERENCES "public"."cidadaos"("id");



ALTER TABLE ONLY "public"."providencias"
    ADD CONSTRAINT "providencias_gabinete_id_fkey" FOREIGN KEY ("gabinete_id") REFERENCES "public"."gabinetes"("id");



ALTER TABLE ONLY "public"."providencias"
    ADD CONSTRAINT "providencias_orgao_destino_id_fkey" FOREIGN KEY ("orgao_destino_id") REFERENCES "public"."orgaos"("id");



ALTER TABLE ONLY "public"."providencias"
    ADD CONSTRAINT "providencias_usuario_responsavel_id_fkey" FOREIGN KEY ("usuario_responsavel_id") REFERENCES "public"."users"("id");



ALTER TABLE ONLY "public"."users"
    ADD CONSTRAINT "users_gabinete_id_fkey" FOREIGN KEY ("gabinete_id") REFERENCES "public"."gabinetes"("id");
...
CREATE POLICY "Admins can insert users" ON "public"."users" FOR INSERT WITH CHECK ((("gabinete_id" = "public"."get_user_tenant_id"()) AND (EXISTS ( SELECT 1
   FROM "public"."users" "users_1"
  WHERE (("users_1"."id" = "auth"."uid"()) AND (("users_1"."role")::"text" = 'admin'::"text"))))));



CREATE POLICY "Admins can manage categorias" ON "public"."categorias" USING ((("gabinete_id" = "public"."get_user_tenant_id"()) AND (EXISTS ( SELECT 1
   FROM "public"."users"
  WHERE (("users"."id" = "auth"."uid"()) AND (("users"."role")::"text" = ANY ((ARRAY['admin'::character varying, 'assessor'::character varying, 'super_admin'::character varying])::"text"[])))))));



CREATE POLICY "Admins can manage orgaos" ON "public"."orgaos" USING ((("gabinete_id" = "public"."get_user_tenant_id"()) AND (EXISTS ( SELECT 1
   FROM "public"."users"
  WHERE (("users"."id" = "auth"."uid"()) AND (("users"."role")::"text" = ANY ((ARRAY['admin'::character varying, 'assessor'::character varying, 'super_admin'::character varying])::"text"[]))))))) WITH CHECK ((("gabinete_id" = "public"."get_user_tenant_id"()) AND (EXISTS ( SELECT 1
   FROM "public"."users"
  WHERE (("users"."id" = "auth"."uid"()) AND (("users"."role")::"text" = ANY ((ARRAY['admin'::character varying, 'assessor'::character varying, 'super_admin'::character varying])::"text"[])))))));



CREATE POLICY "Admins can update users" ON "public"."users" FOR UPDATE USING ((("gabinete_id" = "public"."get_user_tenant_id"()) AND (EXISTS ( SELECT 1
   FROM "public"."users" "users_1"
  WHERE (("users_1"."id" = "auth"."uid"()) AND (("users_1"."role")::"text" = 'admin'::"text"))))));
...
CREATE POLICY "Isolamento por Gabinete" ON "public"."profiles" USING (((( SELECT "auth"."uid"() AS "uid") = "id") OR ("gabinete_id" = ( SELECT "profiles_1"."gabinete_id"
   FROM "public"."profiles" "profiles_1"
  WHERE ("profiles_1"."id" = ( SELECT "auth"."uid"() AS "uid"))
 LIMIT 1)))) WITH CHECK (((( SELECT "auth"."uid"() AS "uid") = "id") OR ("gabinete_id" = ( SELECT "profiles_1"."gabinete_id"
   FROM "public"."profiles" "profiles_1"
  WHERE ("profiles_1"."id" = ( SELECT "auth"."uid"() AS "uid"))
 LIMIT 1))));
...
CREATE POLICY "System can insert notifications" ON "public"."notificacoes" FOR INSERT WITH CHECK (("gabinete_id" = "public"."get_user_tenant_id"()));



CREATE POLICY "Users can insert anexos" ON "public"."anexos" FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."providencias" "p"
  WHERE (("p"."id" = "anexos"."providencia_id") AND ("p"."gabinete_id" = "public"."get_user_tenant_id"())))));



CREATE POLICY "Users can insert cidadaos" ON "public"."cidadaos" FOR INSERT WITH CHECK (("gabinete_id" = "public"."get_user_tenant_id"()));



CREATE POLICY "Users can insert gabinetes" ON "public"."gabinetes" FOR INSERT TO "authenticated" WITH CHECK (true);



CREATE POLICY "Users can insert historico" ON "public"."historico" FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."providencias" "p"
  WHERE (("p"."id" = "historico"."providencia_id") AND ("p"."gabinete_id" = "public"."get_user_tenant_id"())))));



CREATE POLICY "Users can insert history for their tenant providencias" ON "public"."historico_providencias" FOR INSERT WITH CHECK (("providencia_id" IN ( SELECT "providencias"."id"
   FROM "public"."providencias"
  WHERE ("providencias"."gabinete_id" = "public"."get_user_tenant_id"()))));



CREATE POLICY "Users can insert providencias" ON "public"."providencias" FOR INSERT WITH CHECK (("gabinete_id" = "public"."get_user_tenant_id"()));



CREATE POLICY "Users can update cidadaos" ON "public"."cidadaos" FOR UPDATE USING (("gabinete_id" = "public"."get_user_tenant_id"()));



CREATE POLICY "Users can update gabinetes" ON "public"."gabinetes" FOR UPDATE TO "authenticated" USING (true);
...
CREATE POLICY "Users can update providencias" ON "public"."providencias" FOR UPDATE USING (("gabinete_id" = "public"."get_user_tenant_id"()));



CREATE POLICY "Users can update their notifications" ON "public"."notificacoes" FOR UPDATE USING (("usuario_id" = "auth"."uid"()));



CREATE POLICY "Users can view anexos" ON "public"."anexos" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."providencias" "p"
  WHERE (("p"."id" = "anexos"."providencia_id") AND ("p"."gabinete_id" = "public"."get_user_tenant_id"())))));



CREATE POLICY "Users can view categorias in their tenant" ON "public"."categorias" FOR SELECT USING (("gabinete_id" = "public"."get_user_tenant_id"()));



CREATE POLICY "Users can view cidadaos in their tenant" ON "public"."cidadaos" FOR SELECT USING (("gabinete_id" = "public"."get_user_tenant_id"()));



CREATE POLICY "Users can view gabinetes" ON "public"."gabinetes" FOR SELECT TO "authenticated" USING (true);



CREATE POLICY "Users can view historico" ON "public"."historico" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."providencias" "p"
  WHERE (("p"."id" = "historico"."providencia_id") AND ("p"."gabinete_id" = "public"."get_user_tenant_id"())))));



CREATE POLICY "Users can view history of their tenant providencias" ON "public"."historico_providencias" FOR SELECT USING (("providencia_id" IN ( SELECT "providencias"."id"
   FROM "public"."providencias"
  WHERE ("providencias"."gabinete_id" = "public"."get_user_tenant_id"()))));



CREATE POLICY "Users can view orgaos in their tenant" ON "public"."orgaos" FOR SELECT USING (("gabinete_id" = "public"."get_user_tenant_id"()));
...
CREATE POLICY "Users can view providencias in their tenant" ON "public"."providencias" FOR SELECT USING (("gabinete_id" = "public"."get_user_tenant_id"()));



CREATE POLICY "Users can view same gabinete profiles" ON "public"."profiles" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles" "user_profile"
  WHERE (("user_profile"."id" = "auth"."uid"()) AND ("user_profile"."gabinete_id" = "profiles"."gabinete_id")))));



CREATE POLICY "Users can view their notifications" ON "public"."notificacoes" FOR SELECT USING ((("usuario_id" = "auth"."uid"()) OR ("gabinete_id" = "public"."get_user_tenant_id"())));



CREATE POLICY "Users can view users in their tenant" ON "public"."users" FOR SELECT USING (("gabinete_id" = "public"."get_user_tenant_id"()));



CREATE POLICY "admin_full_access" ON "public"."gabinetes" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "allow_public_insert" ON "public"."leads" FOR INSERT TO "anon" WITH CHECK (true);



CREATE POLICY "allow_public_select" ON "public"."leads" FOR SELECT TO "anon" USING (false);
...
CREATE POLICY "gabinetes_manage_member_admins" ON "public"."gabinetes" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles" "me"
  WHERE (("me"."id" = ( SELECT "auth"."uid"() AS "uid")) AND ("me"."gabinete_id" = "gabinetes"."id") AND ("me"."role" = ANY (ARRAY['admin'::"text", 'gestor'::"text"])))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."profiles" "me"
  WHERE (("me"."id" = ( SELECT "auth"."uid"() AS "uid")) AND ("me"."gabinete_id" = "gabinetes"."id") AND ("me"."role" = ANY (ARRAY['admin'::"text", 'gestor'::"text"]))))));



CREATE POLICY "gabinetes_manage_super_admin" ON "public"."gabinetes" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles" "me"
  WHERE (("me"."id" = ( SELECT "auth"."uid"() AS "uid")) AND ("me"."role" = 'super_admin'::"text"))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."profiles" "me"
  WHERE (("me"."id" = ( SELECT "auth"."uid"() AS "uid")) AND ("me"."role" = 'super_admin'::"text")))));



CREATE POLICY "gabinetes_view_member" ON "public"."gabinetes" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles" "me"
  WHERE (("me"."id" = ( SELECT "auth"."uid"() AS "uid")) AND ("me"."gabinete_id" = "gabinetes"."id")))));



CREATE POLICY "gabinetes_view_super_admin" ON "public"."gabinetes" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles" "me"
  WHERE (("me"."id" = ( SELECT "auth"."uid"() AS "uid")) AND ("me"."role" = 'super_admin'::"text")))));
...
ALTER TABLE "public"."historico_providencias" ENABLE ROW LEVEL SECURITY;
...
CREATE POLICY "profiles_update_same_gabinete_admins" ON "public"."profiles" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles" "me"
  WHERE (("me"."id" = ( SELECT "auth"."uid"() AS "uid")) AND ("me"."gabinete_id" IS NOT NULL) AND ("me"."gabinete_id" = "profiles"."gabinete_id") AND ("me"."role" = ANY (ARRAY['admin'::"text", 'gestor'::"text"])))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."profiles" "me"
  WHERE (("me"."id" = ( SELECT "auth"."uid"() AS "uid")) AND ("me"."gabinete_id" IS NOT NULL) AND ("me"."gabinete_id" = "profiles"."gabinete_id") AND ("me"."role" = ANY (ARRAY['admin'::"text", 'gestor'::"text"]))))));



CREATE POLICY "profiles_update_super_admin" ON "public"."profiles" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles" "me"
  WHERE (("me"."id" = ( SELECT "auth"."uid"() AS "uid")) AND ("me"."role" = 'super_admin'::"text"))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."profiles" "me"
  WHERE (("me"."id" = ( SELECT "auth"."uid"() AS "uid")) AND ("me"."role" = 'super_admin'::"text")))));
...
CREATE POLICY "profiles_view_own" ON "public"."profiles" FOR SELECT TO "authenticated" USING ((( SELECT "auth"."uid"() AS "uid") = "id"));



CREATE POLICY "profiles_view_same_gabinete" ON "public"."profiles" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles" "me"
  WHERE (("me"."id" = ( SELECT "auth"."uid"() AS "uid")) AND ("me"."gabinete_id" IS NOT NULL) AND ("me"."gabinete_id" = "profiles"."gabinete_id")))));



CREATE POLICY "profiles_view_super_admin" ON "public"."profiles" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles" "me"
  WHERE (("me"."id" = ( SELECT "auth"."uid"() AS "uid")) AND ("me"."role" = 'super_admin'::"text")))));



ALTER TABLE "public"."providencias" ENABLE ROW LEVEL SECURITY;
...
GRANT ALL ON FUNCTION "public"."accept_invite"("invite_token" "text", "user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."accept_invite"("invite_token" "text", "user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."accept_invite"("invite_token" "text", "user_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."aceitar_convite"("convite_token" "text", "user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."aceitar_convite"("convite_token" "text", "user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."aceitar_convite"("convite_token" "text", "user_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."check_prazo_providencias"() TO "anon";
GRANT ALL ON FUNCTION "public"."check_prazo_providencias"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."check_prazo_providencias"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."create_providencia_history"() TO "anon";
GRANT ALL ON FUNCTION "public"."create_providencia_history"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_providencia_history"() TO "service_role";



GRANT ALL ON FUNCTION "public"."create_super_admin"("admin_email" "text", "admin_password" "text", "admin_name" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."create_super_admin"("admin_email" "text", "admin_password" "text", "admin_name" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_super_admin"("admin_email" "text", "admin_password" "text", "admin_name" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."expirar_convites_antigos"() TO "anon";
GRANT ALL ON FUNCTION "public"."expirar_convites_antigos"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."expirar_convites_antigos"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."generate_protocolo"("tenant_uuid" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."generate_protocolo"("tenant_uuid" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."generate_protocolo"("tenant_uuid" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."obter_estatisticas_gabinete"("gabinete_uuid" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."obter_estatisticas_gabinete"("gabinete_uuid" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."obter_estatisticas_gabinete"("gabinete_uuid" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."planet_osm_line_osm2pgsql_valid"() TO "anon";
GRANT ALL ON FUNCTION "public"."planet_osm_line_osm2pgsql_valid"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."planet_osm_line_osm2pgsql_valid"() TO "service_role";



GRANT ALL ON FUNCTION "public"."planet_osm_point_osm2pgsql_valid"() TO "anon";
GRANT ALL ON FUNCTION "public"."planet_osm_point_osm2pgsql_valid"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."planet_osm_point_osm2pgsql_valid"() TO "service_role";



GRANT ALL ON FUNCTION "public"."planet_osm_polygon_osm2pgsql_valid"() TO "anon";
GRANT ALL ON FUNCTION "public"."planet_osm_polygon_osm2pgsql_valid"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."planet_osm_polygon_osm2pgsql_valid"() TO "service_role";



GRANT ALL ON FUNCTION "public"."planet_osm_roads_osm2pgsql_valid"() TO "anon";
GRANT ALL ON FUNCTION "public"."planet_osm_roads_osm2pgsql_valid"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."planet_osm_roads_osm2pgsql_valid"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."revogar_convite"("convite_id" "uuid", "user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."revogar_convite"("convite_id" "uuid", "user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."revogar_convite"("convite_id" "uuid", "user_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."setup_super_admin_profile"("user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."setup_super_admin_profile"("user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."setup_super_admin_profile"("user_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."update_dashboard_stats"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_dashboard_stats"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_dashboard_stats"() TO "service_role";
...
GRANT ALL ON TABLE "public"."cidadaos" TO "anon";
GRANT ALL ON TABLE "public"."cidadaos" TO "authenticated";
GRANT ALL ON TABLE "public"."cidadaos" TO "service_role";



GRANT ALL ON TABLE "public"."providencias" TO "anon";
GRANT ALL ON TABLE "public"."providencias" TO "authenticated";
GRANT ALL ON TABLE "public"."providencias" TO "service_role";
...
GRANT ALL ON TABLE "public"."gabinetes" TO "anon";
GRANT ALL ON TABLE "public"."gabinetes" TO "authenticated";
GRANT ALL ON TABLE "public"."gabinetes" TO "service_role";
...
GRANT ALL ON TABLE "public"."historico_providencias" TO "anon";
GRANT ALL ON TABLE "public"."historico_providencias" TO "authenticated";
GRANT ALL ON TABLE "public"."historico_providencias" TO "service_role";
...
GRANT ALL ON TABLE "public"."orgaos" TO "anon";
GRANT ALL ON TABLE "public"."orgaos" TO "authenticated";
GRANT ALL ON TABLE "public"."orgaos" TO "service_role";



GRANT ALL ON TABLE "public"."planet_osm_line" TO "anon";
GRANT ALL ON TABLE "public"."planet_osm_line" TO "authenticated";
GRANT ALL ON TABLE "public"."planet_osm_line" TO "service_role";



GRANT ALL ON TABLE "public"."planet_osm_nodes" TO "anon";
GRANT ALL ON TABLE "public"."planet_osm_nodes" TO "authenticated";
GRANT ALL ON TABLE "public"."planet_osm_nodes" TO "service_role";



GRANT ALL ON TABLE "public"."planet_osm_point" TO "anon";
GRANT ALL ON TABLE "public"."planet_osm_point" TO "authenticated";
GRANT ALL ON TABLE "public"."planet_osm_point" TO "service_role";



GRANT ALL ON TABLE "public"."planet_osm_polygon" TO "anon";
GRANT ALL ON TABLE "public"."planet_osm_polygon" TO "authenticated";
GRANT ALL ON TABLE "public"."planet_osm_polygon" TO "service_role";



GRANT ALL ON TABLE "public"."planet_osm_rels" TO "anon";
GRANT ALL ON TABLE "public"."planet_osm_rels" TO "authenticated";
GRANT ALL ON TABLE "public"."planet_osm_rels" TO "service_role";



GRANT ALL ON TABLE "public"."planet_osm_roads" TO "anon";
GRANT ALL ON TABLE "public"."planet_osm_roads" TO "authenticated";
GRANT ALL ON TABLE "public"."planet_osm_roads" TO "service_role";



GRANT ALL ON TABLE "public"."planet_osm_ways" TO "anon";
GRANT ALL ON TABLE "public"."planet_osm_ways" TO "authenticated";
GRANT ALL ON TABLE "public"."planet_osm_ways" TO "service_role";
